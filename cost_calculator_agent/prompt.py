COST_CALCULATOR_AGENT_INSTR="""
    ...
    # Step    
    1. `solution_architect_agent`を呼び出してください。
    2. `solution_architect_agent`のタスクが一度出力してください。
    **出力するもの:**
    <refined_architecture>
    {{ refined_architecture }}
    </refined_architecture>
    3. `parallel_generator_agent`を呼び出してください。
    4. `parallel_generator_agent`すべてのタスクが完了したら以下を出力してください。
    **出力するもの:**
    <refined_code>
    {{ refined_code }}
    </refined_code>
